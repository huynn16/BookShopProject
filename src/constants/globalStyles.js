...
export default {
  ...
  // text
  // ///////////////////////////////////////////////////////////////////////////
  textGroup510: { fontFamily: fonts.Group5Regular, fontSize: 10 },
  textGroup512: { fontFamily: fonts.Group5Regular, fontSize: 12 },
  textGroup514: { fontFamily: fonts.Group5Regular, fontSize: 14 },
  textGroup516: { fontFamily: fonts.Group5Regular, fontSize: 16 },
  textGroup518: { fontFamily: fonts.Group5Regular, fontSize: 18 },
  textGroup5Bold12: { fontFamily: fonts.Group5Bold, fontSize: 12 },
  textGroup5Bold16: { fontFamily: fonts.Group5Bold, fontSize: 16 },
  textGroup5Bold18: { fontFamily: fonts.Group5Bold, fontSize: 18 },
  textGroup5Bold20: { fontFamily: fonts.Group5Bold, fontSize: 20 },
  textGroup5Bold22: { fontFamily: fonts.Group5Bold, fontSize: 22 },
  textGroup5Bold24: { fontFamily: fonts.Group5Bold, fontSize: 24 },
